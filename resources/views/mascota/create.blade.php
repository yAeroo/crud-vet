    ...
    <div class="main-container">
        <div class="hero bg-base-200 min-h-48">
            <div class="hero-content text-center">
                <div class="max-w-md">
                    <h1 class="text-5xl font-bold">Registrar Mascota</h1>
        ...
        <div class="form-container flex justify-center py-12">
            <form action="{{ route('mascotas.store') }}" class="flex flex-col justify-center items-center" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 items-center">
                    ...
                    <div class="row px-5">
                        <select name="especie_id" id="especie_id" class="select select-bordered w-full max-w-xs">
                            <option value="" hidden selected disable> Selecciona la Especie...</option>
                    ...
                    <div class="row px-5">
                        <label class="form-control w-full max-w-xs">
                            ...
                            <input name="fecha_nacimiento" id="fecha_nacimiento" type="date" class="input input-bordered w-full max-w-xs" value="{{ old('fecha_nacimiento') }}" />
                        </label>
                    </div>
                </div>
